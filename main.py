...
cs="mysql://idewofktlttgg7nz:d1yjz40wualr5w69@dcrhg4kh56j13bnu.cbetxkdyhwsb.us-east-1.rds.amazonaws.com:3306/aoe1adeab51zt65c"
...
prompt=ChatPromptTemplate.from_messages([
    (
        ...
        context:
        you must query against the connected database, it has total 5 tables , these are users,country
...
agent.run(prompt.format_prompt(question='change users are in japan to canada'))